...
public class Auto2025RedNear extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // Pedro paths: waypoints (Pose2d) with linear heading interpolation
        ...
        Action tab2 = new FollowPathAction(drive, drive.buildPathChain(p1, p2, p3));
        Action tab3 = new FollowPathAction(drive, drive.buildPath(p3, p4));
        Action tab4 = new FollowPathAction(drive, drive.buildPathChain(p4, p5, p6));
        Action tab5 = new FollowPathAction(drive, drive.buildPath(p6, p7));
        Action tab6_gate = new FollowPathAction(drive, drive.buildPath(p7, p8));
        Action tab7_back = new FollowPathAction(drive, drive.buildPath(p8, p9));
        Action tab8_gate = new FollowPathAction(drive, drive.buildPath(p9, p8));
        Action tab10_park = new FollowPathAction(drive, drive.buildPath(p8, p10));

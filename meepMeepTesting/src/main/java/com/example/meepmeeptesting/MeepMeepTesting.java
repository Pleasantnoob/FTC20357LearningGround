...
public class MeepMeepTesting {
    ...
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity blueFar = new DefaultBotBuilder(meepMeep)
                ...
                .setConstraints(60, 60, Math.PI, Math.PI, 14.25)
                .build();
        RoadRunnerBotEntity blueFarSpike = new DefaultBotBuilder(meepMeep)
                .setColorScheme(new ColorSchemeBlueDark())
                .setConstraints(60, 60, Math.PI, Math.PI, 14.25)
                .build();
        ...
        RoadRunnerBotEntity redFar = new DefaultBotBuilder(meepMeep)
                ...
                .setConstraints(60, 60, Math.PI, Math.PI, 14.25)
                .build();
        RoadRunnerBotEntity redFarSpike = new DefaultBotBuilder(meepMeep)
                .setColorScheme(new ColorSchemeRedDark())
                .setConstraints(60, 60, Math.PI, Math.PI, 14.25)
                .build();
        ...
        blueFarSpike.runAction(blueFarSpike.getDrive().actionBuilder(blueFarStart)
        //shoot
        //run intake
        //pick up spike
                .strafeToLinearHeading(new Vector2d(36, -20), Math.toRadians(270))
                .strafeTo(new Vector2d(36, -54))
                .strafeToLinearHeading(new Vector2d(60, -20), Math.toRadians(270))
                //shoot spike
                .strafeToLinearHeading(new Vector2d(60, -62), Math.toRadians(270))
                .strafeToLinearHeading(new Vector2d(50, -62), Math.toRadians(270))
                .strafeToLinearHeading(new Vector2d(60, -50), Math.toRadians(270))
        ...
        redFar.runAction(redFar.getDrive().actionBuilder(new Pose2d(RED_FAR_START_X, RED_FAR_START_Y, Math.toRadians(RED_FAR_HEADING_DEG)))
                ...
                .strafeTo(new Vector2d(50, 30))
                .build());
        // redFarSpike = mirror of blueFarSpike (Y flipped, 270→90)
        Pose2d redFarStart = new Pose2d(RED_FAR_START_X, RED_FAR_START_Y, Math.toRadians(RED_FAR_HEADING_DEG));
        redFarSpike.runAction(redFarSpike.getDrive().actionBuilder(redFarStart)
                .strafeToLinearHeading(new Vector2d(36, 20), Math.toRadians(90))
                .strafeTo(new Vector2d(36, 54))
                .strafeToLinearHeading(new Vector2d(60, 20), Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(60, 62), Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(50, 62), Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(60, 50), Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(60, 62), Math.toRadians(90))
        ...
        meepMeep.setBackground(MeepMeep.Background.FIELD_DECODE_JUICE_DARK)
                ...
                .addEntity(blueNear)
                .addEntity(blueFar)
                .addEntity(blueFarSpike)
                .addEntity(redNear)
                .addEntity(redFar)
                .addEntity(redFarSpike)
                .start();
    }
}
